...
RECOVERING_STATE_ALPHA = {
    "deposit_rawtx": "",
    "revoke_rawtxs": [],
    "spend_secret": None,
    "deposit_script_hex": "",
    "commits_active": [],
    "expire_rawtxs": [
        ""
    ],
    "payee_wif": None,
    "payout_rawtxs": [],
    "commits_requested": [],
...
class TestRecover(unittest.TestCase):
    ...
    def test_expired_to_recovering(self):
        self.payer.load(EXPIRED_STATE)
        self.payer.update()  # publish expire tx
        self.assertEqual(self.payer.save(), RECOVERING_STATE_ALPHA)

    def test_recovering_to_closed(self):
        self.payer.load(RECOVERING_STATE_BETA)
        self.payer.update()  # does nothing
        self.assertEqual(self.payer.save(), RECOVERING_STATE_BETA)
